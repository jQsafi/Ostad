...
<head>
    ...
    <title>Assignment-1 [Request]</title>
</head>
...
<body>
    ...
    <div class="w3-container" style="padding: 70px;">
        <form action="" method="post" class="">
            <input type="text" class="w3-input w3-border" name="query" placeholder="Search Text Here" value="<?php echo (isset($_REQUEST['query'])?$_REQUEST['query']:'');?>" required />
    ...
    <?php
        ...
        if(count($_REQUEST))
        {
            ?>
                ...
                <form class="w3-padding w3-card-4 w3-third" style="float:left;margin: 0 auto">
            <?php
